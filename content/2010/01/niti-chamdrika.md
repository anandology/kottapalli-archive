...
{{Image("panchatantram.gif", float="center")}}
...
{{Image("pancatantram1.gif", float="right")}}
...
{{Image("pancatantram2.gif", float="center")}}
...
{{Image("neeti_chandrika_eagle.gif", float="right")}}
...
{{Image("neeti_chandrika_pilli.gif", float="right")}}
