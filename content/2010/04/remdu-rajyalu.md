...
extra:
  ...
  intro: "{{ Image(issue=\"2010/04\", filename=\"book_cover.JPG\", float=\"center\"\
    ) }}\n\nఒక రాజ్యం:   \nమంత్రి: పిల్లలు కూడా యుద్ధం ఆటలు ఆడుకుంటూ చదువుకోవడం లేదు\
    \ ప్రభూ!    \nరాజు:  అయితే తెలివైన వాళ్ళందరికీ చదువులు చెప్పించండి. ఎందుకంటే మనం\n\
    విశ్వ విజేతలం. యుద్ధం చేయడానికి కొత్త ఆయుధాలు కనిపెట్టాలంటే‌\nచదువుండాలి. ప్రపంచాన్ని\
    \ పరిపాలించే భాషలు రావాలి. కాబట్టి రాజ్యంలోని\nపిల్లలందరినీ జైళ్ళల్లో పెట్టండి.\
    \     \nమంత్రి : మహారాజా! పిల్లలను జైళ్ళల్లో పెట్టడమేమిటి?    \nరాజు:  బడులు జైళ్ళ\
    \ మాదిరే ఉండాలి. ఎందుకంటే క్రమ శిక్షణ ముఖ్యం. క్రమ\nశిక్షణ నేర్పాలంటే‌  సైనికుల\
    \ మాదిరి శిక్షణ  ఇవ్వాలి. నేటి నుంచీ ఆటలు-\nపాటలు బంద్. మన దేశం ప్రపంచంలోనే మహాశక్తి\
    \ కావాలి.   \n\nఇంకొక రాజ్యం:   \nరాజు: పిల్లలు ఆడుతూ, పాడుతూ, హాయిగా చదువుకోవాలి.\
    \    \nమంత్రి :  కానీ,  కరువు-కాటకాలు.  పైగా యుద్ధం! తల్లిదండ్రులు పిల్లలతో\n\
    పని  చేయిస్తున్నారు మహాప్రభూ!    \nరాజు: వాళ్ళని ఎలాగైనా బడికి చేర్చాలి -    \
    \ \nమంత్రి : తమరు ఆజ్ఞాపించండి మహారాజా!     \nరాజు:  ఆజ్ఞలతో పనులు జరుగుతాయా?\
    \ గుర్రాన్ని నీళ్ళదాకా  తీసుకెళ్తాం.\nకానీ  నీళ్ళు  తాగించలేం కదా?    \nమంత్రి\
    \ : మరేం చెయ్యాలి?    \nరాజు: ఏం  చేస్తే  పనులు జరుగుతాయో, అదే చేస్తాం.  ముందు\
    \  ప్రతి ఊరులోనూ\nబడి పెట్టి,  అందులో అయ్యవారిని నియమించండి.    \n<b>రెండు రాజ్యాలు-\
    \ రెండు మార్గాలు..</b>     \nమార్గాల మధ్య సంఘర్షణలో  అంతిమ విజయం ఎవరిది? చదవండి\
    \ 'దేవి' రచన-    \n\n<b>  రెండు రాజ్యాలు-రెండు దారులు (నాటిక)</b>    \n“కొత్తపల్లి\"\
    \ తెలుగు పిల్లల ఈ (e) మాసపత్రిక, ఏప్రియల్ 2010 సంచికకు అనుబంధం     \n(ఆంధ్రప్రదేశ్\
    \ బాలల నాటకోత్సవాలలో భాగంగా , 2008 లో  హైదరాబాదులోని\nరవీంద్రభారతిలో టింబక్టుబడి\
    \ పిల్లలు\nప్రదర్శించిన నాటికకు అక్షర రూపం)     \n\n\n\nచిత్రాలు      \nకె.శివ\
    \ ప్రసాద్"
---

{{ Image(issue="2010/04", filename="1.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="2.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="3.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="4.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="5.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="6.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="7.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="8.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="9.JPG", float="center") }}
...
{{ Image(issue="2010/04", filename="10.JPG", float="center") }}
