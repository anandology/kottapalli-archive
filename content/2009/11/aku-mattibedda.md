...
extra:
  ...
  intro: '<br>
    ...
    {{ Image(issue="2009/11", filename="Aku_Mattibedda.jpg", float="thumb") }}
...
{{ Image(issue="2009/11", filename="aku,mattigadda.gif", float="center") }}
...
{{ Image(issue="2009/11", filename="aku,mattigadda2.gif", float="right") }}
