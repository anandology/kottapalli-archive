...
extra:
  ...
  intro: '<br>
    ...
    {{ Image(issue="2009/11", filename="Anna_thammula_sahasam.JPG", float="thumb")
    }}
...
{{ Image(issue="2009/11", filename="annadammula_telivi1.gif", float="right") }}
...
{{ Image(issue="2009/11", filename="annadammula_telivi2.gif", float="right") }}
